...
(function() { this.JST || (this.JST = {}); this.JST["employees/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="container-fluid employee-table">\n  <div class="row">\n    <div class="col-sm-6">\n      <h2>Employee List:</h2>\n\n    </div>\n    <div class="col-sm-6">\n      <button class="btn btn-success btn-default add-employee">Add Employee +</button>\n    </div>\n  </div>\n  <!-- Use two tables so header remains in place while data is scrollable -->\n  <table class="table headers">\n    <thead>\n      <tr>\n        <th class="employee_id">ID</th>\n        <th class="birth_date">Birth Date</th>\n        <th class="first_name">First Name</th>\n        <th class="last_name">Last Name</th>\n        <th class="gender">Gender</th>\n        <th class="hire_date">Hire Date</th>\n      </tr>\n    </thead>\n  </table>\n  <div id="table-wrapper">\n    <div id="table-scroll">\n      <table class="table table-striped data">\n        <tbody id="employees">\n\n        </tbody>\n      </table>\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["employees/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="m-background"></div>\n<div class="m-content">\n<button class="close">&times;</button>\n  <form class="new-employee">\n    <h2>Add an Employee</h2>\n    <div class="form-group">\n      ');  if (errors.length === 1) { ; __p.push('\n        <label>Please fix the following errror before resubmitting the form:</label>\n      ');  } else if (errors.length > 1) { ; __p.push('\n        <label>Please fix the following errrors before resubmitting the form:</label>\n      ');  } ; __p.push('\n      <ul class="errors">\n        ');  errors.forEach( function(error) {; __p.push('\n          <li>',  error ,'</li>\n        '); }); __p.push('\n      </ul>\n    </div>\n\n    <div class="form-group">\n      <label>Birthdate:</label>\n      <input\n        type="date"\n        name="employee[birth_date]"\n        class="form-control">\n    </div>\n    <div class="form-group">\n      <label>First Name:</label>\n      <input\n        type="text"\n        name="employee[first_name]"\n        class="form-control">\n    </div>\n    <div class="form-group">\n      <label>Last Name:</label>\n      <input\n        type="text"\n        name="employee[last_name]"\n        class="form-control">\n    </div>\n    <div class="form-group">\n      <strong>Gender:</strong>\n      <div class="radio">\n        <label>\n          <input type="radio" name="employee[gender]" id="male" value="M">\n          Male\n        </label>\n      </div>\n      <div class="radio">\n        <label>\n          <input type="radio" name="employee[gender]" id="female" value="F">\n          Female\n        </label>\n      </div>\n    </div>\n    <div class="form-group">\n      <label>Hire Date:</label>\n      <input\n        type="date"\n        name="employee[hire_date]"\n        class="form-control">\n    </div>\n    <button type="submit" class="btn btn-success btn-default">\n      Submit\n    </button>\n  </form>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["employees/row"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n<td class="employee_id">\n  ',  employee.escape('id') ,'\n</td>\n<td class="birth_date">\n  ',  employee.escape('birth_date') ,'\n</td>\n<td class="first_name">\n  ',  employee.escape('first_name') ,'\n</td>\n<td class="last_name">\n  ',  employee.escape('last_name') ,'\n</td>\n<td class="gender">\n  ',  employee.escape('gender') ,'\n</td>\n<td class="hire_date">\n  ',  employee.escape('hire_date') ,'\n</td>\n');}return __p.join('');};
}).call(this);
